...
const Chapter3 = lazy(() => import("./views/Chapters/Chapter3/Chapter3.jsx"));
const Chapter4 = lazy(() => import("./views/Chapters/Chapter4/Chapter4.jsx"));
    ...
    <Router>
      <Suspense fallback={<LoadingScreen />}>
        ...
        <Routes>
          ...
          <Route path="/chapter3/" element={<Chapter3 acceso={user.acceso}  />} />
          <Route path="/chapter4/" element={<Chapter4 acceso={user.acceso}  />} />
        </Routes>
