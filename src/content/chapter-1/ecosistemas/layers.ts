...
const COMPOSITE_PGW: PGWData = [0.0018443379684604639, 0, 0, -0.0018447264954608695, -77.62486008564038, 6.099219641645617]
const COMPOSITE_W = 1374
const COMPOSITE_H = 2443

const compositeLayer = (id: string, name: string, group: string, order: number, swatch: string): Layer => ({
  id: `eco-composite-${id}`,
  name,
  category: 'ecosystems',
  type: 'raster-pgw',
