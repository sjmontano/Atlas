        ...
        <main>
          ...
          <div className="entramados-content">
            ...
            <div className="buttonsEntramados">
              <a href="https://www.unriocauca.com/" target="_blank" rel="noopener noreferrer" className="btnLogoAtlasEntramados">
                <img className="btnLogoBgEntramados" src={fondoIcon} alt="" />
                <img className="btnLogoImgEntramados" src={logo} alt="Un río Cauca, muchos mundos" />
