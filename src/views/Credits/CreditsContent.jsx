  ...
  return (
    <main>
      <div className="homeCreditos">
        ...
        <a href="https://www.unriocauca.com/" target="_blank" rel="noopener noreferrer" className="btnLogoAtlasCreditos">
          <img className="btnLogoBgCreditos" src={fondoIcon} alt="" />
          <img className="btnLogoImgCreditos" src={logo} alt="Un río Cauca, muchos mundos" />
          <div className="homeTooltip-marker">
      ...
      <section
        ...
        style={{
          background: "linear-gradient(rgba(4, 69, 82, 0.52), rgba(4, 72, 86, 0.6)), url('/assets/svg/fondo.webp')",
          ...
          <div className="description">
            ...
            <div className="icon-text-container">
              ...
              >
                ...
                />
                <span className="text">
                  Colaboratorio de Cartografías críticas y codiseño territorial
                </span>
              </div>
              <div
                className="icon-with-text"
