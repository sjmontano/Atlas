...
const Bienvenidos = ({ acceso = false }) => {
  ...
  const titles = [
    <h3>
      <span className="header-title-normal"> Iniciamos nuestro recorrido</span>
    </h3>,
    <h1>
  ...
  return (
    <div id="cap1">
      ...
      <div className="homeCreditosBienvenidos">
        ...
        <a href="https://www.unriocauca.com/" target="_blank" rel="noopener noreferrer" className="btnLogoAtlasBienvenidos">
          <img className="btnLogoBgBienvenidos" src={fondoIcon} alt="" />
          <img className="btnLogoImgBienvenidos" src={logo} alt="Un río Cauca, muchos mundos" />
          <div className="homeTooltip-marker">
