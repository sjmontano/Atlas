...
import Encuadres from "../../../data/geojsonLayers/encuadres";
import toponimosBredunco from "../../../data/toponimos/bredunco";
...
//geojsonLayers
import capasBredunco from "../../../data/geojsonLayers/capasBredunco";
import capasFormasDelPaisaje from "../../../data/geojsonLayers/capasFormasDelPaisaje";
...
//iconos sidebard
import sidebarIconsChapter1 from "../../../data/sidebardIcons/sidebarIconsChapter1";

//titulos
import titlesChapter1 from "../../../data/titles/titlesChapter1";
...
const Chapter1 = ({acceso=false}) => {
  ...
  const [agregados] = useState([
    ...
    },
    {
      nevados: [],
      encuadres: [],
      toponimos: toponimosTejidosDelAgua,
      capas: [],
  ...
  useEffect(() => {
    ...
    const loadMaps = async () => {
      ...
      const generatedMaps = await getChapterMaps([
        { name: "encuadres" },
        { name: "bredunco" },
        { name: "fomasDelPaisaje" },
        { name: "ecosistemas" } /*ecosistemas */,
        { name: "tejidosDelAgua" } /*tejidosDelAgua */,
        { name: "unRioCaucaMuchosMundos" },
        // ...Agregar más mapas según sea necesario
      ]);
  ...
  return (
    <div id="cap1">
      ...
      {/* Título principal */}
      <Header
        title={titlesChapter1[selectedMap]}
        index={selectedMap}
      ...
      <SidebarLeft
        datos={selectedModal}
        img={selectedMap != 0 ? "" : ""}
        icons={sidebarIconsChapter1[selectedMap]}
        selectedMap={selectedMap}
      />
      {/* Icono del norte */}
