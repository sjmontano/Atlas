...
const Chapter2 = ({acceso=false}) => {
  ...
  useEffect(() => {
    ...
    setSelectedModal(modalsData[27]);
  ...
  return (
    <div id="cap1">
      ...
      {selectedMap==0 && (
        <img   className="aguas" style={{width:"55%", height:"16vh"}} src={img2} alt="" />
      )}

      {selectedMap==1 && (
        <img   className="aguas" style={{width:"40%", height:"16vh"}} src={img2} alt="" />
      )}
