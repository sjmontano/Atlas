...
import capasIntroCap3 from "../../../data/geojsonLayers/capasIntroCap3";


//rasterTiles

//iconos sidebard
import sidebarIconsChapter3 from "../../../data/sidebardIcons/sidebarIconsChapter3";
...
//titulos
import titlesChapter3 from "../../../data/titles/titlesChapter3";
...
const Chapter3 = ({acceso=false}) => {
  ...
  const [agregados] = useState([
    ...
    },
    {
      ...
      rasterTiles: [
        {
      name: "enExplotacion",
      texto: "En explotación (abiertos)",
      id: "enExplotacion-layer",
      sourceId: "enExplotacion_",
      url: "https://res.cloudinary.com/dvluvxfvn/image/upload/v1764944934/geoImages/qzloplawdce64nyoiedi.webp",
      opacity: 0.8,
      icono: "assets/mapasMenuCap2/explotacionAbiertos.svg",

    },

    {
      name: "enReanatualizacion",
      texto: "En proceso renaturalización ",
      id: "enReanatualizacion-layer",
      sourceId: "enReanatualizacion_",
      url: "https://res.cloudinary.com/dvluvxfvn/image/upload/v1764946045/geoImages/sspftyweahtwn6ibv3hx.webp",
      opacity: 0.8,
      icono: "assets/mapasMenuCap2/procesoNaturalizacion.svg",

    },

    {
      name: "enRellenados",
      texto: "Rellenados (cerrados) ",
      id: "enRellenados-layer",
      sourceId: "enRellenados_",
      url: "https://res.cloudinary.com/dvluvxfvn/image/upload/v1764946527/geoImages/mvyoglamwzd6uq5rfxig.webp",
      opacity: 0.8,
      icono: "assets/mapasMenuCap2/rellenos.svg",
  ...
  useEffect(() => {
    ...
    const loadMaps = async () => {
      ...
      const generatedMaps = await getChapterMaps([
        { name: "introduccionCap3" },
        { name: "monocultivo" },
        { name: "nosEncharcaronElRio" },
        { name: "caliDeseca" } ,
        { name: "humedalesCap3" } ,
        { name: "arcilla" } ,
        // ...Agregar más mapas según sea necesario
  ...
  return (
    <div id="cap1">
      ...
      {selectedMap==0 && (
        <img   className="aguas" style={{width:"55%", height:"14vh"}} src={img2} alt="" />
      )}

      {selectedMap==1 && (
        <img   className="aguas" style={{width:"45%", height:"16vh"}} src={img2} alt="" />
      )}

      {selectedMap==6 && (
        <img   className="aguas" style={{width:"35%", height:"16vh"}} src={img2} alt="" />
      )}

       {/* Añadir SidebarLeft aquí */}
    <SidebarLeft
        datos={selectedModal}
      icons={sidebarIconsChapter3[selectedMap]}
      onMapChange={handleMapChange}
      galeriaData={galeriaActual}
    />
      {/* Título principal */}
      <Header
        title={titlesChapter3[selectedMap]}
        index={selectedMap}
        onMapChange={handleMapChange}
      ...
      {selectedMap === 0 && (
        <SidebarBottom
          onMapChange={handleMapChange}
          chapters={chapters}
          selectedChapter={3}  // Cambiado de 1 a 2 para seleccionar el Capítulo 2
        />
      )}
