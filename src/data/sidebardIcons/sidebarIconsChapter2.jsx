...
import gallery from "../../../public/assets/svg/todos/Hud/icons/icon-line-webp/gallery.svg";
...
const sidebarIconsChapter2 = [
  ...
  [
    ...
    { id: 2, icon: gallery, title: "Galería de imágenes" },
    {
      ...
      icon: download,
      title: "Descargar",
      link: "https://drive.google.com/file/d/1TdPc76F125hnZWk5gq84cPJjkZb5zFpb/view?usp=sharing",
    },
    {
      id: 4,
      icon: modelo,
  ...
  [
    ...
    { id: 2, icon: gallery, title: "Galería de imágenes" },
    {
      ...
      icon: download,
      title: "Descargar",
      link: "https://drive.google.com/file/d/1n2rblpgp_p1_3a8uO5MBitZKTSqlpZeH/view",
    },
    {
      id: 4,
      icon: modelo,
