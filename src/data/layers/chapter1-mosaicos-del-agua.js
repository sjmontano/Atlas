...
const WATER_PGW = [0, 0.000166382730, 0.000166392514, 0, -76.968456199726, 2.161908918459]
const WATER_W = 5846
const WATER_H = 10394

const waterLayer = (id, name, group, order, swatch, opacity = 0.8) => ({
  id: `mda-${id}`,
  name,
  category: 'ecosystems',
  type: 'raster-pgw',
...
export const CHAPTER1_WATER_LAYERS = [
