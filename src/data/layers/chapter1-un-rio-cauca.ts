...
const URIO_CAUCA_PGW: PGWData = [0, 0.001232510189, 0.0012309569997728162, 0, -79.27447278696201, -0.6228009147673822]
const URIO_CAUCA_W = 5836
const URIO_CAUCA_H = 10388

const urioLayer = (id: string, name: string, group: string, order: number, opacity: number = 0.8): Layer => ({
  id: `urc-${id}`,
  name,
  category: 'rivers',
  type: 'raster-pgw',
...
export const CHAPTER1_URIOCAUCA_LAYERS: Layer[] = [
