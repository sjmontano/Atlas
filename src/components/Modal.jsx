    ...
    return (
        ...
        >
            ...
            >
                ...
                <button id="btnDerecha" className="absolute top-2 right-2 text-black" onClick={derecha}>
                    
                    <HiArrowCircleRight  color="#0F6E50" size="30px" className="map-marker"/>

                </button>

                <button id="btnIzquierda" className="absolute top-2 right-2 text-black" onClick={izquierda}>
                    
                    <HiArrowCircleLeft  color="#0F6E50" size="30px" className="map-marker"/>
